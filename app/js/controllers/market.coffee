angular.module("app").controller "MarketController", ($scope, $state, $stateParams, $modal, $location, $q, $log, $filter, Wallet, WalletAPI, Blockchain, BlockchainAPI, Growl, Utils, MarketService, Observer, MarketGrid, $interval) ->
    ...
    unless window.bts
        $scope.tabs.push { heading: "market.short", route: "market.short", active: false, class: "tab-short short-text" }
        $scope.tabs.push { heading: "btn.cover", route: "market.cover", active: false, class: "tab-cover cover-text"}
